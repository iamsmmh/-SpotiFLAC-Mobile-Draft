...
const List<List<List<int>>> rsBlockTable = [
  // version 1
  <List<int>>[<int>[1, 26, 19]],
  <List<int>>[<int>[1, 26, 16]],
  <List<int>>[<int>[1, 26, 13]],
  <List<int>>[<int>[1, 26, 9]],
  // version 2
  <List<int>>[<int>[1, 44, 34]],
  <List<int>>[<int>[1, 44, 28]],
  <List<int>>[<int>[1, 44, 22]],
  <List<int>>[<int>[1, 44, 16]],
  // version 3
  <List<int>>[<int>[1, 70, 55]],
  <List<int>>[<int>[1, 70, 44]],
  <List<int>>[<int>[2, 35, 17]],
  <List<int>>[<int>[2, 35, 13]],
  // version 4
  <List<int>>[<int>[1, 100, 80]],
  <List<int>>[<int>[2, 50, 32]],
  <List<int>>[<int>[2, 50, 24]],
  <List<int>>[<int>[4, 25, 9]],
  // version 5
  <List<int>>[<int>[1, 134, 108]],
  <List<int>>[<int>[2, 67, 43]],
  <List<int>>[<int>[2, 33, 15], <int>[2, 34, 16]],
  <List<int>>[<int>[2, 33, 11], <int>[2, 34, 12]],
  // version 6
  <List<int>>[<int>[2, 86, 68]],
  <List<int>>[<int>[4, 43, 27]],
  <List<int>>[<int>[4, 43, 19]],
  <List<int>>[<int>[4, 43, 15]],
  // version 7
  <List<int>>[<int>[2, 98, 78]],
  <List<int>>[<int>[4, 49, 31]],
  <List<int>>[<int>[2, 32, 14], <int>[4, 33, 15]],
  <List<int>>[<int>[4, 39, 13], <int>[1, 40, 14]],
  // version 8
  <List<int>>[<int>[2, 121, 97]],
  <List<int>>[<int>[2, 60, 38], <int>[2, 61, 39]],
  <List<int>>[<int>[4, 40, 18], <int>[2, 41, 19]],
  <List<int>>[<int>[4, 40, 14], <int>[2, 41, 15]],
  // version 9
  <List<int>>[<int>[2, 146, 116]],
  <List<int>>[<int>[3, 58, 36], <int>[2, 59, 37]],
  <List<int>>[<int>[4, 36, 16], <int>[4, 37, 17]],
  <List<int>>[<int>[4, 36, 12], <int>[4, 37, 13]],
  // version 10
  <List<int>>[<int>[2, 86, 68], <int>[2, 87, 69]],
  <List<int>>[<int>[4, 69, 43], <int>[1, 70, 44]],
  <List<int>>[<int>[6, 43, 19], <int>[2, 44, 20]],
  <List<int>>[<int>[6, 43, 15], <int>[2, 44, 16]],
  // version 11
  <List<int>>[<int>[4, 101, 81]],
  <List<int>>[<int>[1, 80, 50], <int>[4, 81, 51]],
  <List<int>>[<int>[4, 50, 22], <int>[4, 51, 23]],
  <List<int>>[<int>[3, 36, 12], <int>[8, 37, 13]],
  // version 12
  <List<int>>[<int>[2, 116, 92], <int>[2, 117, 93]],
  <List<int>>[<int>[6, 58, 36], <int>[2, 59, 37]],
  <List<int>>[<int>[4, 46, 20], <int>[6, 47, 21]],
  <List<int>>[<int>[7, 42, 14], <int>[4, 43, 15]],
  // version 13
  <List<int>>[<int>[4, 133, 107]],
  <List<int>>[<int>[8, 59, 37], <int>[1, 60, 38]],
  <List<int>>[<int>[8, 44, 20], <int>[4, 45, 21]],
  <List<int>>[<int>[12, 33, 11], <int>[4, 34, 12]],
  // version 14
  <List<int>>[<int>[3, 145, 115], <int>[1, 146, 116]],
  <List<int>>[<int>[4, 64, 40], <int>[5, 65, 41]],
  <List<int>>[<int>[11, 36, 16], <int>[5, 37, 17]],
  <List<int>>[<int>[11, 36, 12], <int>[5, 37, 13]],
  // version 15
  <List<int>>[<int>[5, 109, 87], <int>[1, 110, 88]],
  <List<int>>[<int>[5, 65, 41], <int>[5, 66, 42]],
  <List<int>>[<int>[5, 54, 24], <int>[7, 55, 25]],
  <List<int>>[<int>[11, 36, 12], <int>[7, 37, 13]],
  // version 16
  <List<int>>[<int>[5, 122, 98], <int>[1, 123, 99]],
  <List<int>>[<int>[7, 73, 45], <int>[3, 74, 46]],
  <List<int>>[<int>[15, 43, 19], <int>[2, 44, 20]],
  <List<int>>[<int>[3, 45, 15], <int>[13, 46, 16]],
  // version 17
  <List<int>>[<int>[1, 135, 107], <int>[5, 136, 108]],
  <List<int>>[<int>[10, 74, 46], <int>[1, 75, 47]],
  <List<int>>[<int>[1, 50, 22], <int>[15, 51, 23]],
  <List<int>>[<int>[2, 42, 14], <int>[17, 43, 15]],
  // version 18
  <List<int>>[<int>[5, 150, 120], <int>[1, 151, 121]],
  <List<int>>[<int>[9, 69, 43], <int>[4, 70, 44]],
  <List<int>>[<int>[17, 50, 22], <int>[1, 51, 23]],
  <List<int>>[<int>[2, 42, 14], <int>[19, 43, 15]],
  // version 19
  <List<int>>[<int>[3, 141, 113], <int>[4, 142, 114]],
  <List<int>>[<int>[3, 70, 44], <int>[11, 71, 45]],
  <List<int>>[<int>[17, 47, 21], <int>[4, 48, 22]],
  <List<int>>[<int>[9, 39, 13], <int>[16, 40, 14]],
  // version 20
  <List<int>>[<int>[3, 135, 107], <int>[5, 136, 108]],
  <List<int>>[<int>[3, 67, 41], <int>[13, 68, 42]],
  <List<int>>[<int>[15, 54, 24], <int>[5, 55, 25]],
  <List<int>>[<int>[15, 43, 15], <int>[10, 44, 16]],
  // version 21
  <List<int>>[<int>[4, 144, 116], <int>[4, 145, 117]],
  <List<int>>[<int>[17, 68, 42]],
  <List<int>>[<int>[17, 50, 22], <int>[6, 51, 23]],
  <List<int>>[<int>[19, 46, 16], <int>[6, 47, 17]],
  // version 22
  <List<int>>[<int>[2, 139, 111], <int>[7, 140, 112]],
  <List<int>>[<int>[17, 74, 46]],
  <List<int>>[<int>[7, 54, 24], <int>[16, 55, 25]],
  <List<int>>[<int>[34, 37, 13]],
  // version 23
  <List<int>>[<int>[4, 151, 121], <int>[5, 152, 122]],
  <List<int>>[<int>[4, 75, 47], <int>[14, 76, 48]],
  <List<int>>[<int>[11, 54, 24], <int>[14, 55, 25]],
  <List<int>>[<int>[16, 45, 15], <int>[14, 46, 16]],
  // version 24
  <List<int>>[<int>[6, 147, 117], <int>[4, 148, 118]],
  <List<int>>[<int>[6, 73, 45], <int>[14, 74, 46]],
  <List<int>>[<int>[11, 54, 24], <int>[16, 55, 25]],
  <List<int>>[<int>[30, 46, 16], <int>[2, 47, 17]],
  // version 25
  <List<int>>[<int>[8, 132, 106], <int>[4, 133, 107]],
  <List<int>>[<int>[8, 75, 47], <int>[13, 76, 48]],
  <List<int>>[<int>[7, 54, 24], <int>[22, 55, 25]],
  <List<int>>[<int>[22, 45, 15], <int>[13, 46, 16]],
  // version 26
  <List<int>>[<int>[10, 142, 114], <int>[2, 143, 115]],
  <List<int>>[<int>[19, 74, 46], <int>[4, 75, 47]],
  <List<int>>[<int>[28, 50, 22], <int>[6, 51, 23]],
  <List<int>>[<int>[33, 46, 16], <int>[4, 47, 17]],
  // version 27
  <List<int>>[<int>[8, 152, 122], <int>[4, 153, 123]],
  <List<int>>[<int>[22, 73, 45], <int>[3, 74, 46]],
  <List<int>>[<int>[8, 53, 23], <int>[26, 54, 24]],
  <List<int>>[<int>[12, 45, 15], <int>[28, 46, 16]],
  // version 28
  <List<int>>[<int>[3, 147, 117], <int>[10, 148, 118]],
  <List<int>>[<int>[3, 73, 45], <int>[23, 74, 46]],
  <List<int>>[<int>[4, 54, 24], <int>[31, 55, 25]],
  <List<int>>[<int>[11, 45, 15], <int>[31, 46, 16]],
  // version 29
  <List<int>>[<int>[7, 146, 116], <int>[7, 147, 117]],
  <List<int>>[<int>[21, 73, 45], <int>[7, 74, 46]],
  <List<int>>[<int>[1, 53, 23], <int>[37, 54, 24]],
  <List<int>>[<int>[19, 45, 15], <int>[26, 46, 16]],
  // version 30
  <List<int>>[<int>[5, 145, 115], <int>[10, 146, 116]],
  <List<int>>[<int>[19, 75, 47], <int>[10, 76, 48]],
  <List<int>>[<int>[15, 54, 24], <int>[25, 55, 25]],
  <List<int>>[<int>[23, 45, 15], <int>[25, 46, 16]],
  // version 31
  <List<int>>[<int>[13, 145, 115], <int>[3, 146, 116]],
  <List<int>>[<int>[2, 74, 46], <int>[29, 75, 47]],
  <List<int>>[<int>[42, 54, 24], <int>[1, 55, 25]],
  <List<int>>[<int>[23, 45, 15], <int>[28, 46, 16]],
  // version 32
  <List<int>>[<int>[17, 145, 115]],
  <List<int>>[<int>[10, 74, 46], <int>[23, 75, 47]],
  <List<int>>[<int>[10, 54, 24], <int>[35, 55, 25]],
  <List<int>>[<int>[19, 45, 15], <int>[35, 46, 16]],
  // version 33
  <List<int>>[<int>[17, 145, 115], <int>[1, 146, 116]],
  <List<int>>[<int>[14, 74, 46], <int>[21, 75, 47]],
  <List<int>>[<int>[29, 54, 24], <int>[19, 55, 25]],
  <List<int>>[<int>[11, 45, 15], <int>[46, 46, 16]],
  // version 34
  <List<int>>[<int>[13, 145, 115], <int>[6, 146, 116]],
  <List<int>>[<int>[14, 74, 46], <int>[23, 75, 47]],
  <List<int>>[<int>[44, 54, 24], <int>[7, 55, 25]],
  <List<int>>[<int>[59, 46, 16], <int>[1, 47, 17]],
  // version 35
  <List<int>>[<int>[12, 151, 121], <int>[5, 152, 122]],
  <List<int>>[<int>[12, 75, 47], <int>[26, 76, 48]],
  <List<int>>[<int>[39, 54, 24], <int>[14, 55, 25]],
  <List<int>>[<int>[22, 45, 15], <int>[41, 46, 16]],
  // version 36
  <List<int>>[<int>[6, 151, 121], <int>[14, 152, 122]],
  <List<int>>[<int>[6, 75, 47], <int>[34, 76, 48]],
  <List<int>>[<int>[46, 54, 24], <int>[10, 55, 25]],
  <List<int>>[<int>[2, 45, 15], <int>[64, 46, 16]],
  // version 37
  <List<int>>[<int>[17, 152, 122], <int>[4, 153, 123]],
  <List<int>>[<int>[29, 74, 46], <int>[14, 75, 47]],
  <List<int>>[<int>[49, 54, 24], <int>[10, 55, 25]],
  <List<int>>[<int>[24, 45, 15], <int>[46, 46, 16]],
  // version 38
  <List<int>>[<int>[4, 152, 122], <int>[18, 153, 123]],
  <List<int>>[<int>[13, 74, 46], <int>[32, 75, 47]],
  <List<int>>[<int>[48, 54, 24], <int>[14, 55, 25]],
  <List<int>>[<int>[42, 45, 15], <int>[32, 46, 16]],
  // version 39
  <List<int>>[<int>[20, 147, 117], <int>[4, 148, 118]],
  <List<int>>[<int>[40, 75, 47], <int>[7, 76, 48]],
  <List<int>>[<int>[43, 54, 24], <int>[22, 55, 25]],
  <List<int>>[<int>[10, 45, 15], <int>[67, 46, 16]],
  // version 40
  <List<int>>[<int>[19, 148, 118], <int>[6, 149, 119]],
  <List<int>>[<int>[18, 75, 47], <int>[31, 76, 48]],
  <List<int>>[<int>[34, 54, 24], <int>[34, 55, 25]],
  <List<int>>[<int>[20, 45, 15], <int>[61, 46, 16]],
];
